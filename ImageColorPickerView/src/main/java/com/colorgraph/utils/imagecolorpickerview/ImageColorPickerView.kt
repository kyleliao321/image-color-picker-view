package com.colorgraph.utils.imagecolorpickerview
...
class ImageColorPickerView @JvmOverloads constructor(
    ...
    init {
        ...
        pickerStrokeWidth = (pickerStrokeWidth * density).toInt()
        ...
        attrs?.let {
            ...
            with(a) {
                ...
                pickerStrokeWidth =
                    getDimension(R.styleable.ImageColorPickerView_pickerStrokeWidth, 5f).toInt()
                pickerStrokeColor =
